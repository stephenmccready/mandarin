...
<div class="container-fluid">
	...
	<div class="box">
		<div>how much?</div><div class="character">若干</div><div class="btn-group btn-group-lg">
			<button type="button" class="btn btn-huge btn-danger" onclick="play('duo1');">duō</button>
			<button type="button" class="btn btn-huge btn-success" onclick="play('shao3');">shǎo</button>
		</div>
	</div>
	<div class="box">
		<div>do you have?</div><div class="character">你有</div><div class="btn-group btn-group-lg">
			<button type="button" class="btn btn-huge btn-success" onclick="play('ni3');">nǐ</button>
			<button type="button" class="btn btn-huge btn-success" onclick="play('you3');">yǒu</button>
		</div>
	</div>
	<div class="box">
		<div>just looking</div><div class="character">看看</div><div class="btn-group btn-group-lg">
			<button type="button" class="btn btn-huge btn-primary" onclick="play('kan4');">kàn</button>
			<button type="button" class="btn btn-huge btn-primary" onclick="play('kan4');">kàn</button>
		</div>
	</div>
	...
	<div class="box">
		<div>extra large</div><div class="character">加大号</div><div class="btn-group btn-group-lg">
			<button type="button" class="btn btn-huge btn-danger" onclick="play('jia1');">jiā</button>
			<button type="button" class="btn btn-huge btn-primary" onclick="play('da4');">dà</button>
			<button type="button" class="btn btn-huge btn-primary" onclick="play('hao4');">hào</button>
		</div>
	</div>
	<div class="clearfix"></div>
	<div class="box">
		<div>tie</div><div class="character">领带</div><div class="btn-group btn-group-lg">
			<button type="button" class="btn btn-huge btn-success" onclick="play('ling3');">lǐng</button>
			<button type="button" class="btn btn-huge btn-primary" onclick="play('dai4');">dài</button>
		</div>
	</div>
	<div class="box">
		<div>suit</div><div class="character">西服</div><div class="btn-group btn-group-lg">
	...
	<div class="box">
		<div>coat</div><div class="character">外套</div><div class="btn-group btn-group-lg">
			<button type="button" class="btn btn-huge btn-primary" onclick="play('wai4');">wài</button>
			<button type="button" class="btn btn-huge btn-primary" onclick="play('tao4');">tào</button>
		</div>
	</div>
	<div class="box">
		<div>jacket</div><div class="character">夹克</div><div class="btn-group btn-group-lg">
			<button type="button" class="btn btn-huge btn-warning" onclick="play('jia2');">jiá</button>
			<button type="button" class="btn btn-huge btn-primary" onclick="play('ke4');">kè</button>
		</div>
	</div>
	<div class="box">
		<div>skirt</div><div class="character">裙子</div><div class="btn-group btn-group-lg">
			<button type="button" class="btn btn-huge btn-warning" onclick="play('qun2');">qún</button>
			<button type="button" class="btn btn-huge btn-danger" onclick="play('zi1');">zi</button>
		</div>
	</div>
	<div class="box">
		<div>gloves</div><div class="character">手套</div><div class="btn-group btn-group-lg">
			<button type="button" class="btn btn-huge btn-success" onclick="play('shou3');">shǒu</button>
			<button type="button" class="btn btn-huge btn-primary" onclick="play('tao4');">tào</button>
		</div>
	</div>
</div>
<script src="js/chinese.js"></script>
<script>$("#breadcrumb").html("&#9986;&nbsp;basics&nbsp;基本 > &#128179;&nbsp;shopping&nbsp;店 >");</script>
</body>
</html>
